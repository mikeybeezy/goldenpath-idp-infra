...
# =============================================================================
# TEARDOWN V4 - Enhanced EKS Cluster Teardown Runner with Secrets Cleanup
# =============================================================================
#
# Version: 4.0.0
# Purpose: Reliable teardown of EKS clusters with proper resource ordering
#          including Secrets Manager cleanup for idempotent re-deploys
#
...
#
# Usage:
#   bootstrap/60_tear_down_clean_up/goldenpath-idp-teardown-v4.sh <cluster-name> <region>
#
# Required:
