...
bash bootstrap/30_core-addons/10_aws_lb_controller.sh goldenpath-dev-eks eu-west-2 <vpc-id>
bash bootstrap/30_core-addons/20_cert_manager.sh goldenpath-dev-eks eu-west-2
bash bootstrap/40_platform-tooling/10_argocd_apps.sh dev
bash bootstrap/40_platform-tooling/20_kong_ingress.sh goldenpath-dev-eks eu-west-2
bash bootstrap/50_smoke-tests/10_kubeconfig.sh goldenpath-dev-eks eu-west-2
bash bootstrap/50_smoke-tests/20_audit.sh goldenpath-dev-eks eu-west-2
