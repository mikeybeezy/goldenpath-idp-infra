...
env: development
generated_at: 2026-01-21T06:11:57Z
source:
  branch: development
  sha: dde4d5e5b28af5c88022529c37c9cf2b1bbf836c
pipeline:
...
| `extension-capability` | Allowed value |
...
| `terraform-destroy` | Allowed value |
| `helm-rollback` | Allowed value |
| `argocd-sync` | Allowed value |
| `rerun-validation` | Allowed value |
| `rerun-teardown` | Allowed value |
| `not-applicable` | Allowed value |
| `none` | Allowed value |
...
| Value | Description |
| :--- | :--- |
| `cluster-only` | Allowed value |
| `bootstrap-only` | Allowed value |
| `cluster+bootstrap` | Allowed value |
...
| Value | Description |
| :--- | :--- |
| `ON_DEMAND` | Allowed value |
| `SPOT` | Allowed value |

## Eks Gitops Controllers
| Value | Description |
| :--- | :--- |
| `argocd` | Allowed value |

## Eks Bootstrap Profiles
| Value | Description |
| :--- | :--- |
| `core-tooling` | Allowed value |
| `tooling-plus-sample-apps` | Allowed value |

## Eks Ingress Providers
| Value | Description |
| :--- | :--- |
| `kong` | Allowed value |
