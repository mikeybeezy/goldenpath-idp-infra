---
id: aws-inventory-2026-01-10
title: AWS Inventory Report (2026-01-10T00:44:01Z)
type: documentation
...
# AWS Inventory Report (2026-01-10T00:44:01Z)
...
## Missing Tags (sample)
- REDACTED / eu-west-2 / cloudformation / arn:aws:cloudformation:eu-west-2:REDACTED:stack/eksctl-devops-test-cluster-cluster/0295e760-df58-11f0-94ab-0a5259aeb55d — missing: Project, Owner, Environment
- REDACTED / eu-west-2 / ec2 / arn:aws:ec2:eu-west-2:REDACTED:instance/i-02c3f30e4da9835e7 — missing: Project, Owner, Environment
- REDACTED / eu-west-2 / ec2 / arn:aws:ec2:eu-west-2:REDACTED:subnet/subnet-0a47288eafb977e8d — missing: Project, Owner, Environment
- REDACTED / eu-west-2 / ec2 / arn:aws:ec2:eu-west-2:REDACTED:subnet/subnet-0327f0cf0ba0d9821 — missing: Project, Owner, Environment
- REDACTED / eu-west-2 / ec2 / arn:aws:ec2:eu-west-2:REDACTED:vpc/vpc-0fabff1a751926ada — missing: Project, Owner, Environment
- REDACTED / eu-west-2 / elasticloadbalancing / arn:aws:elasticloadbalancing:eu-west-2:REDACTED:targetgroup/k8s-kongsyst-devkongk-83562ef1e8/93e16c82f0466f3d — missing: Project, Owner, Environment
- REDACTED / eu-west-2 / elasticloadbalancing / arn:aws:elasticloadbalancing:eu-west-2:REDACTED:targetgroup/k8s-kongsyst-devkongk-5944eeee31/002e4ee4c7f7869c — missing: Project, Owner, Environment
- REDACTED / eu-west-2 / dynamodb / arn:aws:dynamodb:eu-west-2:REDACTED:table/goldenpath-idp-dev-db — missing: Owner, Environment
- REDACTED / eu-west-2 / ec2 / arn:aws:ec2:eu-west-2:REDACTED:instance/i-0f1000de1f4b16da9 — missing: Project, Owner, Environment
- REDACTED / eu-west-2 / ec2 / arn:aws:ec2:eu-west-2:REDACTED:internet-gateway/igw-0f40d4eb861e3c421 — missing: Project, Owner, Environment
