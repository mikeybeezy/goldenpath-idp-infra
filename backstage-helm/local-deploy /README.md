...
helm install backstage /Users/mikesablaze/Documents/relaunch/goldenpath-idp-infra/backstage-helm/charts/backstage \
  --namespace backstage \
  --create-namespace \
...
``` bash
helm repo add platformers-community https://platformerscommunity.github.io/backstage-helm-chart/ #need to refine
```
