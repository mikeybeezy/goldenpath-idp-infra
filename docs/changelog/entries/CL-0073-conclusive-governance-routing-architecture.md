...
- **Platform-wide Strategy**: Published the [**`DECISION_ROUTING_STRATEGY.md`**](file:///Users/mikesablaze/goldenpath-idp-infra/docs/governance/DECISION_ROUTING_STRATEGY.md).
