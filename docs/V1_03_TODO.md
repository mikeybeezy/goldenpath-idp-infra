...
| 036 | P1 | Governance | Clear technical debt and tag all existing IAM policies | platform | Open | M |  | Audit IAM policies and backfill required tags | docs/35_RESOURCE_TAGGING.md, docs/adrs/ADR-0037-platform-resource-tagging-policy.md | Enable tag-scoped cleanup and reliable audits |
...
| 042 | P1 | Observability | Define RED label contract (service/env/version/team/build_id) | platform | Done | S | Q1 | Implement in dashboards + alerts | docs/05_OBSERVABILITY_DECISIONS.md | Consistent metrics for dashboards and alerts |
