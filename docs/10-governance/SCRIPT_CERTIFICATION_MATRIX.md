...
|---|---|---|---:|---:|---|---|---|
| `scripts/archive_sessions.py` | `SCRIPT-0036` | `platform-team` | ⭐ 1 | ✅ | `pytest` | `declared` | `low` |
...
| `scripts/generate_test_proofs.py` | `SCRIPT-0058` | `platform-team` | ⭐ 1 | ✅ | `pytest` | `declared` | `none` |
...
| `scripts/rag-data-sync.sh` | `SCRIPT-0064` | `platform-team` | ⭐ 1 | 🚫 | `bash` | `manual` | `low` |
...
| `scripts/record-test-metrics.sh` | `SCRIPT-0061` | `platform-team` | ⭐ 1 | 🚫 | `bash` | `manual` | `low` |
