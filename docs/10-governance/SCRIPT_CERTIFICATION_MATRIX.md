...
| `scripts/generate_script_matrix.py` | `generate_script_matrix` | `platform-team` | ⭐⭐⭐ 3 | ✅ | `pytest` | `declared` | `none` |
...
| `scripts/validate_scripts_tested.py` | `validate_scripts_tested` | `platform-team` | ⭐⭐⭐ 3 | ✅ | `pytest` | `declared` | `none` |
