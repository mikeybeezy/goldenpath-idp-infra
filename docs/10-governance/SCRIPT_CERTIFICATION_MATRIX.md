...
| `scripts/eks_build_parser.py` | `SCRIPT-0050` | `platform-team` | ⭐⭐ 2 | ❌ | `pytest` | `execution` | `low` |
...
| `scripts/verify_deployment.py` | `SCRIPT-0048` | `platform-team` | ⭐⭐ 2 | ❌ | `manual` | `declared` | `low` |
