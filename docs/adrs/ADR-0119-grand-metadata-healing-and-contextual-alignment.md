...
4.  **Preserve Intent**: Only placeholder values will be overwritten; explicit metadata provided by authors will remain untouched unless it violates schema bounds.
