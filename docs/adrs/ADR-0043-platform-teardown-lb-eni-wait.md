...
- **Related:** `bootstrap/60_tear_down_clean_up/goldenpath-idp-teardown.sh`, `docs/15_TEARDOWN_AND_CLEANUP.md`, `.github/workflows/ci-teardown.yml`, `docs/policies/ci-teardown-extra-permissions.json`
