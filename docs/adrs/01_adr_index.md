...
| [ADR-0168](ADR-0168-eks-request-parser-and-mode-aware-workflows.md) | Platform | EKS Request Parser and Mode-Aware Workflows | Accepted | 2026-01-17 | EKS requests now follow the contract-driven parser flow with explicit modes, build_id requirements, and CI validation to generate deterministic tfvars. |
| [ADR-0169](ADR-0169-secret-request-system-generated-ids.md) | Platform | System-Generated SecretRequest IDs with CI Immutability Guard | Accepted | 2026-01-17 | SecretRequest IDs are generated by workflow, removed from user input, and enforced as immutable with filename matching in CI. |
<!-- ADR_TABLE_END -->
