...
| [ADR-0114](ADR-0114-automated-enum-consistency-validation.md) | Platform | Automated Enum Consistency Validation | Proposed | 2026-01-06 | With the introduction of unified enums in [ADR-0113](ADR-0113-platform-queryable-intelligence-enums.md), we need a mechanism to enforce thes... |
