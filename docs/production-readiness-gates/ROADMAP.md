...
| 055 | P2 | Backstage | TechDocs: switch local build to S3 publisher | platform | Open | M | Q2 | Configure TechDocs S3 bucket + IAM and enable publisher | docs/production-readiness-gates/ROADMAP.md | Faster, more reliable doc builds at scale |
