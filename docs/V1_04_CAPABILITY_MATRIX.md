...
| **Observability baseline (RED + Golden Signals)** | Metrics-first RED signals with derived Golden Signals dashboards and minimal alerts. | Prometheus/Grafana + docs/05_OBSERVABILITY_DECISIONS.md | 🚧 In progress | Traces deferred to V1.1; labels and dashboards are the V1 focus. |
