...
class TestInjector(unittest.TestCase):
    ...
    def test_inject_py_preserves_shebang(self):
        ...
        meta = {
            ...
            "test": {"runner": "pytest", "command": "echo test", "evidence": "declared"},
        ...
        self.assertEqual(lines[0], "#!/usr/bin/env python3", "Shebang must be first line")
        self.assertTrue(lines[1].startswith('"""'), "Metadata block should start on line 2")
        self.assertIn('print("Hello")', p.read_text(), "Original code must be preserved")
