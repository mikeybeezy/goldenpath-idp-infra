...
- `docs/catalogs/ecr-catalog.yaml` contains sample registries

### Test Data
Created 3 sample registries in `docs/catalogs/ecr-catalog.yaml`:
...
- Input: `docs/catalogs/ecr-catalog.yaml`
