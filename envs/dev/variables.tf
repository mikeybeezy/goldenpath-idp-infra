...
variable "iam_config" {
  ...
  type = object({
    ...
    enable_rds_provisioner_role               = optional(bool, false)
    rds_provisioner_role_name                 = optional(string, "goldenpath-idp-rds-provisioner")
    rds_provisioner_service_account_namespace = optional(string, "platform-system")
    rds_provisioner_service_account_name      = optional(string, "platform-provisioner")
  })
  validation {
  ...
  default = {
    ...
    enable_rds_provisioner_role               = false
