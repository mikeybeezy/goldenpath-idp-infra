...
| S5 | Scripts | platform_health.py catalog assumptions | Script scans non-existent docs/catalogs and misses demo catalog variants, undercounting catalog health. | Med | Low | Direct | P1 | Platform health metrics reflect actual catalogs. |
